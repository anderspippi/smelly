...
def parse_unicode_input_args(args: List[str]) -> Tuple[UnicodeCLIOptions, List[str]]:
    return parse_args(args, OPTIONS, usage, help_text, 'smelly +kitten unicode_input', result_class=UnicodeCLIOptions)
