...
The password to use to skip the transfer confirmation popup in smelly. Must match
the password set for the :opt:`file_transfer_confirmation_bypass` option in
:file:`smelly.conf`. Note that leading and trailing whitespace is removed from
