...
from wellies.tui.operations import raw_mode, styled
from smelly.cli import parse_args
from smelly.cli_stub import ShowKeyCLIOptions
...
default=normal
type=choices
choices=normal,application,smelly,unchanged
The keyboard mode to use when showing keys. :code:`normal` mode is with DECCKM
reset and :code:`application` mode is with DECCKM set. :code:`smelly` is the full
smelly extended keyboard protocol.
'''.format
