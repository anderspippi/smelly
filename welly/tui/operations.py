...
from smelly.rgb import color_as_sharp, to_color
from smelly.typing import GraphicsCommandType, HandlerType, ScreenSize, UnderlineLiteral
...
def overlay_ready() -> str:
    return '\x1bP@smelly-overlay-ready|\x1b\\'
...
def as_type_stub() -> str:
    ans = [
        ...
        'from smelly.typing import GraphicsCommandType, ScreenSize',
        'from smelly.fast_data_types import Color',
        'import smelly.rgb',
        'import wellies.tui.operations',
    ]
    methods = []
    for name, func in all_cmds.items():
