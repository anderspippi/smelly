...
from smelly.multiprocessing import get_process_pool_executor
from smelly.rgb import color_as_sgr, parse_sharp
...
def main() -> None:
    # smelly +runpy "from wellies.diff.highlight import main; main()" file
    import sys
