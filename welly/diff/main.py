...
from smelly.cli import CONFIG_HELP, CompletionSpec, parse_args
from smelly.cli_stub import DiffCLIOptions
from smelly.conf.utils import KeyAction
...
from smelly.utils import ScreenSize, extract_all_from_tarfile_safely
...
def main(args: List[str]) -> None:
    ...
    cli_opts, items = parse_args(args[1:], OPTIONS, usage, help_text, 'smelly +kitten diff', result_class=DiffCLIOptions)
    if len(items) != 2:
