...
--config -c
type=list
Path to config file to use for smelly when drawing the panel.


--override -o
type=list
Override individual smelly configuration options, can be specified multiple times.
Syntax: :italic:`name=value`. For example: :option:`smelly +kitten panel -o` font_size=20
