...
|smelly| is capable of running multiple programs organized into tabs and windows.
...
:term:`smelly windows <window>`. The smelly windows can be arranged in multiple
...
<conf-smelly-shortcuts>`) for tabs and windows are:
...
Additionally, you can define shortcuts in :file:`smelly.conf` to focus
...
Action                              Shortcut
==================================  =======================
Show this help                      :sc:`show_smelly_doc`
...
Edit :file:`smelly.conf`             :sc:`edit_config_file` (also :kbd:`⌘+,` on macOS)
Reload :file:`smelly.conf`           :sc:`reload_config_file` (also :kbd:`⌃+⌘+,` on macOS)
Debug :file:`smelly.conf`            :sc:`debug_config` (also :kbd:`⌥+⌘+,` on macOS)
Open a |smelly| shell                :sc:`smelly_shell`
