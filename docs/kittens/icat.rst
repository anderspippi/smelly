...
The ``icat`` kitten can be used to display arbitrary images in the |smelly|
terminal. Using it is as simple as::

    smelly +kitten icat image.jpeg
...
:doc:`smelly graphics protocol </graphics-protocol>`.

You might want to create an alias in your shell's configuration files::

   alias icat="smelly +kitten icat"
...
consider writing proper support for the :doc:`smelly graphics protocol
