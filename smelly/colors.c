...
#define as_dict_doc "Return all colors as a dictionary of color_name to integer or None (names are the same as used in smelly.conf)"
...
PyTypeObject Color_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "smelly.fast_data_types.Color",
