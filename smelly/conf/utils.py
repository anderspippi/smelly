...
def parse_wellies_func_args(action: str, args_funcs: Dict[str, KeyFunc[Tuple[str, Any]]]) -> KeyAction:
...
welliesKeyDefinition = Tuple[ParsedShortcut, KeyAction]
...
def parse_wellies_key(val: str, funcs_with_args: Dict[str, KeyFunc[Tuple[str, Any]]]) -> Optional[welliesKeyDefinition]:
    ...
    if not sc or not action:
        return None
    ans = parse_wellies_func_args(action, funcs_with_args)
