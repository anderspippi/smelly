...
detect_spacer_strategy(hb_font_t *hbf, Font *font) {
    ...
    // https://github.com/backbiter-no/smelly/issues/4721
...
collapse_pua_space_ligature(index_type num_cells) {
    ...
    // so special case it: https://github.com/backbiter-no/smelly/issues/1225
    g->num_glyphs = 1;
}
    ...
    for (i=0, first_cell_in_run=0; i < line->xnum; i++) {
        ...
        if (
            ...
            while (
                ...
                // for the space and the PUA. See for example: https://github.com/backbiter-no/smelly/issues/467
