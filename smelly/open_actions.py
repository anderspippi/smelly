...
protocol file
ext sh,command,tool
action launch --hold --type=os-window smelly +shebang $FILE_PATH $SHELL

# Open shell specific script files
protocol file
ext fish,bash,zsh
action launch --hold --type=os-window smelly +shebang $FILE_PATH __ext__
...
protocol file
mime image/*
action launch --type=os-window smelly +kitten icat --hold $FILE_PATH
