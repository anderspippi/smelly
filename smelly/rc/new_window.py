...
class NewWindow(RemoteCommand):
    ...
    window_type/choices.smelly.os: One of :code:`smelly` or :code:`os`
    ...
    desc = (
        ...
        'Open a new window in the specified tab. If you use the :option:`smelly @ new-window --match` option'
...
the working directory for the smelly process you are talking to is.
...
default=smelly
choices=smelly,os
What kind of window to open. A smelly window or a top-level OS window.
