...
static PyObject*
wrapped_wellies(PyObject *self UNUSED, PyObject *args UNUSED) {
    const char *wrapped_kitten_names = WRAPPED_wellies;
...
static PyMethodDef module_methods[] = {
    ...
    {"wrapped_kitten_names", (PyCFunction)wrapped_wellies, METH_NOARGS, ""},
#ifdef __APPLE__
...
extern bool init_wellies(PyObject *module);
...
#ifdef smelly_VCS_REV
    PyModule_AddStringMacro(m, smelly_VCS_REV);
#endif
