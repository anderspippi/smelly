...
# isort: skip_file
import typing
from smelly.conf.utils import merge_dicts, positive_float, positive_int, to_bool, to_cmdline, to_color, to_color_or_none, unit_float
from smelly.options.utils import (
    action_alias,
...
class Parser:
    ...
    def smelly_mod(self, val: str, ans: typing.Dict[str, typing.Any]) -> None:
        ans['smelly_mod'] = to_modifiers(val)
