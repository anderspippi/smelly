...
from smelly.fast_data_types import CURSOR_BEAM, CURSOR_BLOCK, CURSOR_UNDERLINE, Color, SingleKey
from smelly.fonts import FontFeature, FontModification, ModificationType, ModificationUnit, ModificationValue
from smelly.key_names import character_key_name_aliases, functional_key_name_aliases, get_key_name_lookup
from smelly.rgb import color_as_int
from smelly.types import FloatEdges, MouseEvent
from smelly.utils import expandvars, log_error, resolve_abs_or_config_path
...
@func_with_args('set_background_opacity', 'goto_layout', 'toggle_layout', 'smelly_shell', 'show_smelly_doc', 'set_tab_title')
...
def resolve_key_mods(smelly_mod: int, mods: int) -> int:
    return SingleKey(mods=mods).resolve_smelly_mod(smelly_mod).mods
