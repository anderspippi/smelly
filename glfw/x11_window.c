...
_glfwPlatformGetClipboard(GLFWClipboardType clipboard_type, const char* mime_type, GLFWclipboardwritedatafun write_data, void *object) {
    ...
    if (strcmp(mime_type, "text/plain") == 0) {
        // UTF8_STRING is what xclip uses by default, and there are people out there that expect to be able to paste from it with a single read operation. See https://github.com/backbiter-no/smelly/issues/5842
        // Also ancient versions of GNOME use DOS line endings even for text/plain;charset=utf-8. See https://github.com/backbiter-no/smelly/issues/5528#issuecomment-1325348218
