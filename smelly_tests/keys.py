...
class TestKeys(BaseTest):
    def test_encode_key_event(self):
        ...
        shift, alt, ctrl, super, hyper, meta = (
            defines.GLFW_MOD_SHIFT,
            defines.GLFW_MOD_ALT,
            defines.GLFW_MOD_CONTROL,
            defines.GLFW_MOD_SUPER,
            defines.GLFW_MOD_HYPER,
            defines.GLFW_MOD_META,
        )  # noqa
        ...
        # legacy key tests {{{
        # start legacy letter tests (auto generated by gen-key-constants.py do
        # not edit)
