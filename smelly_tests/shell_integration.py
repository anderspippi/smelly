...
from smelly.bash import decode_ansi_c_quoted_string
from smelly.constants import smelly_base_dir, shell_integration_dir, terminfo_dir
from smelly.fast_data_types import CURSOR_BEAM, CURSOR_BLOCK, CURSOR_UNDERLINE
from smelly.shell_integration import setup_bash_env, setup_fish_env, setup_zsh_env
...
def safe_env_for_running_shell(argv, home_dir, rc='', shell='zsh'):
    ...
    if shell == 'zsh':
        ...
        ans['smelly_BASH_INJECT'] += ' posix'
        ans['smelly_BASH_POSIX_ENV'] = os.path.join(home_dir, '.bashrc')
        with open(ans['smelly_BASH_POSIX_ENV'], 'w') as f:
...
''',
    ...
    ''',
        ...
        def setup_env(excluded, argv, home_dir, rc='', shell='bash'):
            ...
            ans['smelly_BASH_ETC_LOCATION'] = home_dir
            ans['PS1'] = 'PROMPT $ '
            return ans
