...
from wellies.ssh.options.utils import DELETE_ENV_VAR
from wellies.transfer.utils import set_paths
...
'''
                ...
                # isnt in contents
                contents.discard(f'{tname}/x/xterm-smelly')
                contents.discard(f'{tname}/78/xterm-smelly')
                self.ae(contents, {
                    'g.1', 'g.2', f'{tname}/smelly.terminfo', 'simple-file', 'd1/d2/x', 'd1/y', 'a/sfa', 's1', 's2',
                    '.local/share/smelly-ssh-kitten/smelly/version', '.local/share/smelly-ssh-kitten/smelly/bin/smelly',
